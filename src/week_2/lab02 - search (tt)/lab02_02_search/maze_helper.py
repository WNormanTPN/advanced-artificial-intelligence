...
def animate_maze(result, repeat=False):
    ...
    plt.text(
        start[1], start[0], "S", fontsize=10, color="white", horizontalalignment="center", verticalalignment="center"
    )

    plt.text(
        goal[1], goal[0], "G", fontsize=10, color="white", horizontalalignment="center", verticalalignment="center"
    )
    ...
    ani = animation.FuncAnimation(fig, step, frames=len(mazes), repeat=repeat)
